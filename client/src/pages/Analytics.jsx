...
//           <span className="text-sm text-gray-500">/admin/analytics</span>
//         </div>

//         <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 space-y-2">
//           <label className="text-sm font-medium text-gray-700">Admin Key (x-admin-key)</label>
//           <input
//             value={adminKey}
//             onChange={(e) => setAdminKey(e.target.value)}
//             placeholder="Enter ADMIN_API_KEY"
//             className="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-black/20"
//           />
...
//             <Card title="Total Queries" value={summary.queries} />
//             <Card title="Avg Response (ms)" value={summary.avgResponseTimeMs} />
//           </div>
//         )}
...
//               <BarChart width={520} height={280} data={topQueries}>
...
//           <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4">
//             <h3 className="font-semibold mb-3">Daily Volume (14 days)</h3>
//             <div className="overflow-x-auto">
//               <LineChart width={520} height={280} data={daily}>
//                 <CartesianGrid strokeDasharray="3 3" />
//                 <XAxis dataKey="date" />
//                 <YAxis />
//                 <Tooltip />
